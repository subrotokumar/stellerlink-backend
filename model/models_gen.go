...
type Character struct {
	...
	Eidolons   []*Eidolons `json:"eidolons"`
}

type Eidolons struct {
...
type Stats struct {
	...
	AscensionMaterials []*Material `json:"ascensionMaterials,omitempty"`
}
...
func (e Path) IsValid() bool {
	switch e {
	case PathDestruction, PathThe, PathHunt, PathErudition, PathHarmony, PathNihility, PathPreservation, PathAbundance:
		return true
	}
	return false
}
